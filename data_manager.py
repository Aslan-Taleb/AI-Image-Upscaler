...
import matplotlib.pyplot as plt # a effacer
#from absl import app # a effacer
...
class DataManager:
    ...
    def load_data(self):
        ...
        # Mise en place d un image  orgininale donne, converti et en gris
        imageOrigine = Image.open(r"C:/Users/emman/Desktop/InfoGraphie/fc.DL.Autoencoder.Denoising.Alexbooth (1)/fc.DL.Autoencoder.Denoising.Alexbooth/src/celebo/000001.jpg")
        ...
        # Mise en place
        imageBis = Image.open(r"C:/Users/emman/Desktop/InfoGraphie/fc.DL.Autoencoder.Denoising.Alexbooth (1)/fc.DL.Autoencoder.Denoising.Alexbooth/src/celebo/000001.jpg")
        ...
        liste_chemin = glob.glob("C:/Users/emman/Desktop/InfoGraphie/fc.DL.Autoencoder.Denoising.Alexbooth (1)/fc.DL.Autoencoder.Denoising.Alexbooth/src/celebo/*.jpg")
